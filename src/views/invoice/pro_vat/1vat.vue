...
<script>
  import { getList, adddata, update, delData, delarr, getInfo } from '@/api/invoice/pro_vat/1vat.js'
    ...
    methods: {
      ...
      handleSelect() {
        let params = {
          ...
          invoiceDate: dateTimes(this.obj2.invoiceDate).substr(0, 10) || '',
      ...
      handleExport() {
        ...
        exportData(getToken(), this.delarrs, '/invoice/invoice_1vat/export', '增值税1%专票')
      },
      handleBatchExport(){
        this.$confirm('是否按当前搜索条件导出', '提示', {
          ...
          BatchExport(getToken(), this.batch, '/invoice/invoice_1vat/export/all', '增值税1%专票');
        }).catch(() => {
