...
<script>
  import { getList, adddata, update, delData, delarr,getInfo } from '@/api/invoice/pro_vat/3vat.js'
  ...
  export default {
    ...
    methods: {
      ...
      handleExport() {
        ...
        exportData(getToken(), this.delarrs, '/invoice/invoice_3vat/export', '增值税3%专票');
      },
      handleBatchExport(){
        this.$confirm('是否按当前搜索条件导出', '提示', {
          ...
          BatchExport(getToken(), this.batch, '/invoice/invoice_3vat/export/all', '增值税3%专票')
        })
      }
    }
  }
