      ...
      <div>
        <el-col :span="24" :xs="24">
          ...
          >
            ...
            <el-form-item label="不含税金额：" prop="taxFreeAmount">
              <el-input
                placeholder="请输入关键词"
...
export default {
  ...
  methods: {
    ...
    handleSubmit() {
      ...
      if (
        !this.obj.invoiceCode ||
        !this.obj.invoiceType ||
        !this.obj.invoiceNumber ||
        !this.obj.invoiceDate ||
        !this.obj.checkCode
      ) {
      ...
      this.$confirm("是否按当前搜索条件导出", "提示", {
        ...
        .then(() => {
          ...
          BatchExport(
            getToken(),
            this.batch,
            "/invoice/invoice_vat/export/all",
            "增值税普票"
          );
        })
        .catch(() => {});
