      ...
      <div>
        <el-col :span="24" :xs="24">
          <el-form ref="queryForm" :inline="true" label-width="100px">
            ...
            <el-form-item label="导入分公司：" prop="phonenumber">
              <el-input
                placeholder="请输入关键词"
                v-model="obj2.branch"
                clearable
        ...
        <el-dialog :visible.sync="centerDialogVisible">
          <el-form ref="obj" :inline="true" label-width="180px" name="obj">
            <el-form-item label="发票种类：" :required="true">
              <el-select v-model="obj.invoiceType" filterable placeholder="请选择关键词" style="width:200px">
            ...
            <el-form-item v-if="obj.invoiceType==23||obj.invoiceType==24||obj.invoiceType==25||obj.invoiceType==''"
                          label="是否注明旅客身份证：" prop="stateIdentity">

              <el-select v-model="obj.stateIdentity" name="stateIdentity" placeholder="请选择关键词" style="width:200px">
            ...
            <el-form-item v-if="obj.invoiceType==23||obj.invoiceType==24||obj.invoiceType==25||obj.invoiceType==''"
              ...
              <el-select v-model="obj.domesticAndForeign" name="domesticAndForeign" style="width:200px"
                         placeholder="请选择关键词">
            ...
            <el-form-item v-if="obj.invoiceType==23||obj.invoiceType==''" label="票价：" prop="fare">
              <el-input
                placeholder="请输入关键词"
                v-model="obj.fare"
                style="width:200px"
            ...
            <el-form-item v-if="obj.invoiceType==23||obj.invoiceType==''" label="民航发展基金：" prop="mhFund">
              <el-input
                placeholder="请输入关键词"
                v-model="obj.mhFund"
                style="width:200px"
            ...
            <el-form-item v-if="obj.invoiceType==23||obj.invoiceType==''" label="燃油附加费：" prop="ryAdditionalFee">
              <el-input
                placeholder="请输入关键词"
            ...
            <el-form-item v-if="obj.invoiceType==23||obj.invoiceType==''" label="其他税费：" prop="otherTaxes">
              <el-input
                placeholder="请输入关键词"
            ...
            <el-form-item v-if="obj.invoiceType==24||obj.invoiceType==''" label="可报帐金额：" prop="reportableAmount">
              <el-input
                placeholder="请输入关键词"
...
<script>
  import { getList, adddata, update, delData, delarr ,getInfo} from '@/api/invoice/common/common.js'
  ...
  export default {
    ...
    methods: {
      ...
      handleSubmit() {
        ...
        if(this.obj.invoiceType==13||this.obj.invoiceType==14||this.obj.invoiceType==16) {
        ...
        if (!data1.invoiceType || !data1.invoiceNumber || !data1.invoiceDate || !data1.money) {
      ...
      handleExport() {
        ...
        exportData(getToken(), this.delarrs, '/invoice/invoice_machine/export', '通用机打发票')
      },
      handleBatchExport(){
        this.$confirm('是否按当前搜索条件导出', '提示', {
          ...
          BatchExport(getToken(), this.batch, '/invoice/invoice_machine/export/all', '通用机打发票')
        });
      }
