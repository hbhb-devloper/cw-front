<template>
  <div class="containers">
    <el-form :model="queryParams" ref="queryForm" label-width="160px" :inline="true">
...
<!--        <el-button  type="danger" icon="el-icon-delete" size="mini" @click="handleExport">删除</el-button>-->
    ...
    <el-table :data="tableData" v-loading="loading">
      ...
      <el-table-column prop="taxpayerCredentials" width="200px" align="center" label="纳税人资质"></el-table-column>
      <el-table-column prop="taxRate" width="200px" align="center" label="税率"></el-table-column>
      <el-table-column prop="updateTime" width="200px" align="center" label="数据更新时间"></el-table-column>
      <el-table-column prop="sellerName" width="200px" align="center" label="发票销售方名称"></el-table-column>
      <el-table-column prop="sellerTaxpayerCode" width="200px" align="center" label="发票销售纳税人识别号"></el-table-column>
      <el-table-column prop="businessLicense" width="200px" align="center" label="营业执照名称"></el-table-column>
      <el-table-column prop="businessTaxpayerCode" width="200px" align="center" label="营业执照纳税人识别号"></el-table-column>
      <el-table-column prop="legalPerson" width="200px" align="center" label="法人"></el-table-column>
    </el-table>
    <pagination
      v-show="total>0"
      :total="total"
