<template>
  <div class="app-container">
    <section class="import-box">
      <ul>
        <li class="import-title" @click="handleExportTemplate(0)">
          酬金发放表模板下载
        </li>
        <li>
          <el-button type="primary" @click="handleOpen(0)" round
            >酬金发放表导入</el-button
          >
        </li>
      </ul>
      <ul>
        <li class="import-title" @click="handleExportTemplate(1)">
          综合补贴模板下载
        </li>
        <li>
          <el-upload
      ...
      <ul>
        <li class="import-title" @click="handleExportTemplate(2)">
          往来账模板下载
        </li>
        <li>
          <el-upload
