  ...
  <div class="containers">
    ...
    <section class="table-box">
      ...
      <el-table v-loading="loading" :data="tableData">
        ...
        <el-table-column label="购买方税号" prop="buyerTax" width="180" align="center"/>
        <el-table-column label="购买方名称" prop="buyerName" width="180" align="center"/>
        <el-table-column label="金额" prop="amount" align="center"/>
        <el-table-column label="税额" prop="taxAmount" align="center"/>
        <el-table-column label="价格合计" prop="taxIncludeAmount" align="center"/>
        <el-table-column label="校验码" prop="checkCode" width="180" align="center"/>
        <el-table-column label="销售方地址、电话"  prop="sellerContact" width="150" align="center"/>
        <el-table-column label="销售方开户行及账号" prop="sellerAccount" width="150" align="center"/>
        <el-table-column label="购买方地址、电话" prop="buyerContact" width="150" align="center"/>
        <el-table-column label="购买方开户行及账号" prop="buyerAccount" width="150" align="center"/>
        ...
        <el-table-column label="货物或应税劳务名称" prop="goodsName" width="150" align="center"/>
    ...
    methods:{
      ...
      handleExport(){
        ...
        this.$confirm('是否确认导出数据?', '提示', {
          ...
          exportData(getToken(), data, '/invoice/inspection/export', '增值税发票查验');
        });
      },
      resetQuery(){
        this.queryParams={
