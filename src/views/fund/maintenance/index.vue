<template>
  <div class="app-container">
    <div class="uploadList">
      <div style="color: blue; cursor: pointer" @click="handleDow">
        发票单位信息导入模板下载
      </div>
      <div style="color: red">
    ...
    <el-table v-loading="loading" :data="TableData">
      ...
      >
        <template slot-scope="scope">
          <el-button size="mini" type="text" @click.stop="handleOpen(scope.row)"
            >编辑</el-button
          >
        </template>
      </el-table-column>
...
export default {
  ...
  methods: {
    ...
    handleDow() {
      exportData1(getToken(), {}, `${prefix}/unit/export`, "发票信息导入模板");
    },
