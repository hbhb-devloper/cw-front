    ...
    <el-table v-loading="loading"
      ...
      <el-table-column label="合同签订请款"
        ...
        <el-table-column label="有赔迁改项目数量（个）"
                         ...
                         width="150"
                         align="center" />
        <el-table-column label="签订赔补协议数量（个）"
                         prop="contractAmount"
                         width="150"
                         align="center" />
        <el-table-column label="已签订赔补协议项目数"
                         prop="contractNumAmount"
                         width="150"
                         align="center" />
        <el-table-column label="未签订赔补协议项目数"
                         prop="notContractNumAmount"
                         width="150"
                         align="center" />
        <el-table-column label="赔补合同签订率（按项目个数计）"
                         prop="compensationRatio"
                         width="150"
                         align="center" />
        <el-table-column label="签订赔补协议金额（万元）"
                         prop="contractAccount"
                         width="150"
                         align="center" />
        <el-table-column label="未签订赔补现已项目成本金额（万元）"
                         prop="notContractAccount"
                         width="150"
                         align="center" />
      </el-table-column>
      <el-table-column label="合同履行情况"
                       width="150"
                       align="center">
        <el-table-column label="赔补款累计到账金额（万元）"
                         prop="compensationTotal"
                         width="150"
                         align="center" />
        <el-table-column label="有赔迁改项目累计成本金额（万元）"
                         prop="costTotal"
                         width="150"
                         align="center" />
        <el-table-column label="回款成本收支比"
                         prop="costRation"
                         width="150"
                         align="center" />
        ...
        <el-table-column label="尾款未收金（万元）"
                         ...
                         width="150"
                         align="center" />
        <el-table-column label="未全额回款合同1年内（个）"
                         prop="oneNotCostAmount"
                         width="150"
                         align="center" />
        <el-table-column label="未全额回款合同1-3年（个）"
                         prop="twoNotCostAmount"
                         width="150"
                         align="center" />
        <el-table-column label="未全额回款合同3年以上（个）"
                         prop="threeNotCostAmount"
                         width="150"
                         align="center" />
        <el-table-column label="当年赔补开票（万元）"
    ...
    <el-dialog :title="title"
      ...
      <el-form ref="form"
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="发票点"
                          prop="nickName">
              <el-date-picker v-model="form.data"
                              type="date"
                              placeholder="选择发票点"></el-date-picker>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="业务类型"
              ...
              <el-date-picker v-model="form.data"
                              type="date"
                              placeholder="选择业务类型"></el-date-picker>
            </el-form-item>
          </el-col>
          <el-col :span="12">
