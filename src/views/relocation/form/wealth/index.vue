<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true">
      <el-row>
        <el-form-item label="区县" prop="flowTypeName">
          <el-input
        ...
        <el-form-item label="年份" prop="flowTypeName">
          <el-input
            v-model="queryParams.flowTypeName"
            placeholder="请输入年份"
            clearable
        ...
        <el-form-item label="项目类型" prop="flowTypeName">
          <el-input
            v-model="queryParams.flowTypeName"
            placeholder="请输入项目类型"
            clearable
        ...
        <el-form-item label="项目名称" prop="flowTypeName">
          <el-input
            v-model="queryParams.flowTypeName"
            placeholder="请输入项目名称"
            clearable
        ...
        <el-form-item label="项目割接或完成时间" prop="flowTypeName">
          <el-input
            v-model="queryParams.flowTypeName"
            placeholder="请输入项目割接或完成时间"
            clearable
            size="small"
            style="width: 240px"
            @keyup.enter.native="handleQuery"
        ...
        <el-form-item label="立项时间" prop="flowTypeName">
          <el-input
            v-model="queryParams.flowTypeName"
            placeholder="请输入立项时间"
            clearable
        ...
        <el-form-item label="预付款是否完全到账" prop="flowTypeName">
          <el-input
            v-model="queryParams.flowTypeName"
            placeholder="请输入预付款是否完全到账"
            clearable
            size="small"
            style="width: 240px"
            @keyup.enter.native="handleQuery"
    ...
    <el-table v-loading="loading" :data="typeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="县区" prop="id" width="120" align="center" />
      <el-table-column label="项目类型" prop="flowTypeName" width="150" align="center" />
      <el-table-column label="EOMS工单号" prop="flowTypeName" width="150" align="center" />
      <el-table-column label="项目名称" prop="flowTypeName" width="150" align="center" />
      <el-table-column label="项目割接或完成时间" prop="flowTypeName" width="150" align="center" />
      <el-table-column label="预算费用" prop="flowTypeName" width="150" align="center" />
      <el-table-column label="材料费" prop="flowTypeName" width="150" align="center" />
      <el-table-column label="施工费" prop="flowTypeName" width="150" align="center" />
      <el-table-column label="项目约定赔补金额" prop="flowTypeName" width="150" align="center" />
      <el-table-column label="理赔支付方式" prop="flowTypeName" width="150" align="center" />
      <el-table-column label="立项时间" prop="flowTypeName" width="150" align="center" />
      <el-table-column label="完工时间" prop="flowTypeName" width="150" align="center" />
      ...
      <el-table-column label="合同甲方" prop="flowTypeName" width="150" align="center" />
      <el-table-column label="合同经办人" prop="flowTypeName" width="150" align="center" />
      <el-table-column label="合同金额" prop="flowTypeName" width="150" align="center" />
      <el-table-column label="初始化已回收金额" prop="flowTypeName" width="350" align="center" />
      <el-table-column label="预付款应收金额" prop="flowTypeName" width="250" align="center" />
      <el-table-column label="预付款回收金额" prop="flowTypeName" width="150" align="center" />
      <el-table-column label="预付款是否完全到账" prop="flowTypeName" width="150" align="center" />
      <el-table-column label="1月回款" prop="flowTypeName" width="150" align="center" />
      <el-table-column label="2月回款" prop="flowTypeName" width="150" align="center" />
      <el-table-column label="3月回款" prop="flowTypeName" width="150" align="center" />
      <el-table-column label="4月回款" prop="flowTypeName" width="150" align="center" />
      <el-table-column label="5月回款" prop="flowTypeName" width="150" align="center" />
      <el-table-column label="6月回款" prop="flowTypeName" width="150" align="center" />
      <el-table-column label="7月回款" prop="flowTypeName" width="150" align="center" />
      <el-table-column label="8月回款" prop="flowTypeName" width="150" align="center" />
      <el-table-column label="9月回款" prop="flowTypeName" width="150" align="center" />
      <el-table-column label="10月回款" prop="flowTypeName" width="150" align="center" />
      <el-table-column label="11月回款" prop="flowTypeName" width="150" align="center" />
      <el-table-column label="12月回款" prop="flowTypeName" width="150" align="center" />
      <el-table-column label="待回收金额（合同金额-当前已回收金）" prop="flowTypeName" width="150" align="center" />
      <el-table-column label="已开票金额" prop="flowTypeName" width="150" align="center" />
