<template>
  <div class="containers">
    ...
    <section class="search-box">
      <el-row :span="24">
        <el-form :inline="true" label-width="100px">
          ...
          <el-form-item style="margin-left: 30px;">
            ...
            <el-date-picker v-show="radio==3" v-model="obj.date" type="year"
                            format="yyyy"
                            value-format="yyyy" placeholder="请选择"
                            style="width: 200px;">
            </el-date-picker>
            <el-date-picker v-show="radio==6" v-model="obj.date" type="month"
                            format="yyyy-MM"
          ...
          <el-form-item label="类型">
            <el-select v-model="obj.budgetType" filterable placeholder="请选择" style="width: 200px;">
      ...
      <el-row>
        <el-button type="primary" size="mini" @click="handleAdd">添加申报</el-button>
        <el-button type="warning" icon="el-icon-download" size="mini" @click="handleExport">导出数据</el-button>
      </el-row>
    </section>
    <!--    表格-->
    <section class="table-box">
      <el-table
        ...
        :data="tableData"
      >
        <el-table-column prop="lineNumber" label="序号" align="center"></el-table-column>
        <el-table-column prop="projectNum" label="编号" align="center"></el-table-column>
        ...
        <el-table-column prop="budgetName" label="项目类型" align="center"></el-table-column>
        <el-table-column prop="cost" label="不含税金额(元)" align="center"></el-table-column>
        <el-table-column prop="vatRate" label="税率" align="center">
          <template slot-scope="scope">
            <span>{{scope.row.vatRate|filterVat}}</span>
          </template>
        </el-table-column>
        <el-table-column prop="taxIncludeAmount" label="价税合计" align="center"></el-table-column>
        <el-table-column prop="createBy" label="申报人" align="center"></el-table-column>
      ...
      <el-dialog :title="title" :visible.sync="open">
          <el-form :inline="true" label-width="130px">
            <el-form-item label="类型" required>
              <el-select v-model="obj2.budgetType" filterable placeholder="请选择" style="width: 200px;">
                <el-option :value="undefined" label="---全部类型---"></el-option>
                <el-option
                  v-for="(item,index) in options"
                  :key="index"
            ...
            <el-form-item label="税率" required>
              <el-select v-model="obj2.vatRate" @change="handleVatRate" filterable placeholder="请选择税率" style="width: 200px;">
                <el-option
            ...
            <el-button type="primary" style="margin-left: 40%;" :disabled="formState" @click="submitForm">确 定</el-button>
            <el-button @click="cancel">取 消</el-button>
          </el-form>
      </el-dialog>
      <el-dialog title="申报详情" :visible.sync="open2">
        <el-row :span="24" class="info-row">
          <el-col :span="12">
            <el-col :span="7" class="info-title">序号</el-col><el-col :span="12">{{info.lineNumber}}</el-col>
          </el-col>
          <el-col :span="12">
            <el-col :span="8" class="info-title">编号</el-col><el-col :span="12">{{info.projectNum}}</el-col>
          </el-col>
        </el-row>
        <el-row :span="24" class="info-row">
          <el-col :span="12">
            <el-col :span="7" class="info-title">名称</el-col><el-col :span="12">{{info.projectName}}</el-col>
          </el-col>
          <el-col :span="12">
            <el-col :span="8" class="info-title">单位</el-col><el-col :span="12">{{info.unitName}}</el-col>
          </el-col>
        </el-row>
        <el-row :span="24" class="info-row">
          <el-col :span="12">
            <el-col :span="7" class="info-title">项目类型</el-col><el-col :span="12">{{info.budgetName}}</el-col>
          </el-col>
          <el-col :span="12">
            <el-col :span="8" class="info-title">不含税金额(万元)</el-col><el-col :span="12">￥{{info.cost}}</el-col>
          </el-col>
        </el-row>
        <el-row :span="24" class="info-row">
          <el-col :span="12">
            <el-col :span="7" class="info-title">税率</el-col><el-col :span="12">{{info.vatRate|filterVat}}</el-col>
          </el-col>
          <el-col :span="12">
            <el-col :span="8" class="info-title">价税合计</el-col><el-col :span="12">{{info.taxIncludeAmount}}</el-col>
          </el-col>
        </el-row>
        <el-row :span="24" class="info-row">
          <el-col :span="12">
            <el-col :span="7" class="info-title">申报人</el-col><el-col :span="12">{{info.createBy}}</el-col>
          </el-col>
        </el-row>
        <el-row>
          ...
          <el-col>
            <el-table :data="Filetable">
              <el-table-column prop="fileName" align="center" label="标题">
                <template slot-scope="scope">
                  <a :download="scope.row.fileName" :href="dowFile+scope.row.filePath">{{scope.row.fileName}}</a>
                </template>
              </el-table-column>
        ...
        <el-button style="margin: 30px 0 0 90%;" size="mini" @click="open2=false">关闭</el-button>
      </el-dialog>
    </section>
  </div>
</template>
    ...
    methods:{
      ...
      handleVatRate(){
        if(parseFloat(this.obj2.cost)){
          ...
          this.obj2.taxIncludeAmount=(parseFloat(this.obj2.cost)*vatRate).toFixed(6);
        }
      },
      //导出
      handleExport(){
        ...
        this.$confirm('是否确认导出日常性费用申报的数据?', '提示', {
          ...
          exportData(getToken(), queryForm, '/budget/agile/export/subsidy', '日常性费用申报');
        });
      },
      //详情
      handleInfo(row){
