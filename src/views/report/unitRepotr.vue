  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true">
      ...
      <el-form-item label="管理内容" prop="hallId">
       ...
       <el-form-item label="报表名称" prop="hallId">
        <el-input
          v-model="queryParams.hallId"
          placeholder="请输入报表名称"
          clearable
       ...
       <el-form-item label="报表状态" prop="hallId">
        <el-input
          v-model="queryParams.hallId"
          placeholder="请输入报表状态"
          clearable
      ...
      <el-form-item label="报表周期" prop="time">
        <el-date-picker
      ...
      <el-form-item label="名称管理" prop="hallId">
        <el-input
          v-model="queryParams.hallId"
          placeholder="请输入名称管理"
          clearable
    ...
    <el-table v-loading="loading" :data="purchaseList">
      <el-table-column align="center" label="序号" prop="goodsName" />
      <el-table-column align="center" label="关联单名称" prop="goodsName" />
      <el-table-column align="center" label="有无业务" prop="unit" />
      <el-table-column align="center" label="管理内容" prop="modifyAmount" />
      <el-table-column align="center" label="报表名称" prop="size" />
      <el-table-column align="center" label="报表周期" prop="attribute" />
      <el-table-column align="center" label="创建人" prop="paper" />
      <el-table-column align="center" label="创建时间" prop="unitName" />
      <el-table-column align="center" label="流程状态" prop="checker" />
    </el-table>
