    ...
    <el-row>
      ...
      <el-col :span="24">
        <div class="ef-tooltar">
          ...
          <el-button type="text" icon="el-icon-download" size="large" @click="savaData">保存流程</el-button>
          <!--                    <el-divider direction="vertical"></el-divider>-->
...
<script>
import { delProp, delLine } from "@/api/flow/vfd";
...
import { addProject, getProject } from "@/api/flow/project";
      ...
      this.jsPlumb.ready(() => {
        ...
        this.jsPlumb.bind("connection", (evt) => {
          ...
          if (this.loadEasyFlowFinish) {
            this.data.lineList.push({ from: from, to: to, id: id });
          }
        });
